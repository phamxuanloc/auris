...
<div class="order-search">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-1">
                <a class="btn btn-danger" href="<?= Yii::$app->urlManager->createUrl(['order/index', 'type' => 1])?>">Hôm qua</a>
            </div>
            <div class="col-md-1">
                <a class="btn btn-warning" href="<?= Yii::$app->urlManager->createUrl(['order/index', 'type' => 2])?>">Hôm nay</a>
            </div>
