...
class AdminController extends BaseAdminController {
	...
	*/
	...
	/*Tạo tài khoản chăm sóc khách hàng*/
	...
	/*Tạo tài khoản nhân viên center*/
	...
	public function actionTest() {
		...
		$array1                     = User::find()->all();
		$model                      = new Model();
		$array1                     = $model->getTotalChildren(null);
		$array2                     = $model->getTotalChildren(1);
		$array3                     = array(1);
		...
		$out   = [];
		for($i = 0; $i < $total; $i ++) {
			array_push($out, User::findOne($data[$i]));
		}
		return $out;
	}
	...
	public function actionList() {
		if(isset($_POST['depdrop_parents'])) {
			...
			if($parents != null) {
				...
				$model   = new Model();
				$array1  = $model->getTotalChildren(null);
				$array2  = $model->getTotalChildren($user_id);
				$array3  = array($user_id);
